...
class CFMDecoder(torch.nn.Module):
    def __init__(self, hidden_channels, out_channels, filter_channels, n_heads, n_layers, kernel_size, p_dropout, gin_channels,mel_proj = False, mel_input_channels=80, mel_proj_channels = 256):
        super().__init__()
        ...
        self.estimator = Decoder(hidden_channels, out_channels, filter_channels, p_dropout, n_layers, n_heads, kernel_size, gin_channels,mel_proj=mel_proj,mel_input_channels=mel_input_channels,mel_proj_channels=mel_proj_channels)
