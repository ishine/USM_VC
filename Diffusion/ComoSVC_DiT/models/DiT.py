# References:
# https://github.com/KdaiP/StableTTS/blob/main/models/dit.py
...
class DiTConVBlock(nn.Module):
    ...
    def forward(self, x, c, x_mask):
        ...
        shift_msa, scale_msa, gate_msa, shift_mlp, scale_mlp, gate_mlp = self.adaLN_modulation(c).transpose(1,2).chunk(6, dim=1)
