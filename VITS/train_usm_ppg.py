...
def run(rank, n_gpus, hps):
    ...
    train_dataset = TextAudioLoader_map2phn_Mixdict3(hps.data.training_files, hps.data)
    train_sampler = DistributedBucketSampler(
        train_dataset,
        hps.train.batch_size,
        [100, 400, 700, 1000, 1500, 2000],  # 20s [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1500, 2000]
        num_replicas=n_gpus,
        rank=rank,
        shuffle=True,
    )
    ...
    if rank == 0:
        eval_dataset = TextAudioLoader_map2phn_Mixdict3(hps.data.validation_files, hps.data, is_train=False)
